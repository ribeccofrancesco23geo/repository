...
var Confini = ee.FeatureCollection("users/ribeccofrancesco23geo/Confini");
...
//Cloud Masking: vado a mascherare pixel nuvolosi dall'immagine
...
var maskcloud1 = function(ImmagineMedia) {
  ...
  return ImmagineMedia.updateMask(clouds.not()); 
};
...
// Minimo e massimo valore SWIRED
...
//Minimo e massimo valore Indice di separazione acqua - mare (SEA Index)
...
var campionamentopunticorretti = classificazionemanuale.sampleRegions({
  ...
  properties: ['correzione'], //Nome campo punti corretti in QGIS (modificato da constant a correzione)
  scale: 10,
  geometries: true
});
